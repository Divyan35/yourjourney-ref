...
let AuthenticationService = class AuthenticationService {
    ...
    registerTraveller(traveller) {
        ...
        return this.http.post('http://localhost:3000/traveller/register', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.json()));
    }
    authenticateTraveller(traveller) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/traveller/authenticate', traveller, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(res => res.json()));
    }
    getInfo() {
        this.getToken();
...
let TraveltimeDataService = class TraveltimeDataService {
    ...
    gettravellingdata() {
        return this.http.get('http://localhost:3000/traveller/gettime').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
    travellingdata(traveldata) {
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_2__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/traveller/traveldata', traveldata, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
    deletedata(id) {
        return this.http.delete('http://localhost:3000/traveller/traveldelete/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => res.json()));
    }
};
